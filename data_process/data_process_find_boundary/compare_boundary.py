...
if robot_option == 1:
    ...
    robot = 'five_link/'
dir1 = file_dir + 'dairlib_data/find_boundary/' + robot + '2D_rom/2D_task_space/' + 'robot_' + str(robot_option) + \
        '_large_iter100/'
dir2 = file_dir + 'dairlib_data/find_boundary/' + robot + '2D_rom/2D_task_space/' + 'robot_' + str(robot_option) + \
       '_small_iter200/'
